...
<body>
<div id="gadai" class="container">
    <br>
<div class="row">
  <div class="col-sm-2">
  </div>
  <div class="col-sm-8" style="border: 1px solid grey;padding:6px; text-align: center;">
...
<div class="mb-3 row">
  ...
  <div class="row">
   ...
   <div style="border: 1px solid black; height: 150px; width: 150px;  background: #F5FAFF;">
    ...
    <input type="file" name="image" id="image" onchange="loadFile(event)" class="form-control" required accept="image/*" / style="width:149px;" required>
...
<script>
 ...
 <div id="msg-price"> </div>
    ...
    <div class="col-sm-7">
      ...
      <div style="border: 1px solid whitesmoke;padding:10px; text-align: center;border-radius: 25px;" class="abhi">
        <input type="checkbox" name="declare"  class="abhijit">
